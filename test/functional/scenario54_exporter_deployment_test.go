...
// ============================================================================
// Scenario 54: Exporter Deployment
// ============================================================================
//
...
// Scenario54ExporterDeploymentSuite tests the exporter deployment resources
// through the AdminReconciler and builder.
type Scenario54ExporterDeploymentSuite struct {
	suite.Suite
	ctx context.Context
}

func TestFunctional_Scenario54(t *testing.T) {
	t.Parallel()
	suite.Run(t, new(Scenario54ExporterDeploymentSuite))
}

func (s *Scenario54ExporterDeploymentSuite) SetupTest() {
	s.ctx = context.Background()
}

func (s *Scenario54ExporterDeploymentSuite) reqFor(cluster *cbv1alpha1.CloudberryCluster) ctrl.Request {
	return ctrl.Request{
...
// scenario54FullExporterCluster returns a cluster with full exporter configuration
// for testing exporter deployment resources.
func scenario54FullExporterCluster() *cbv1alpha1.CloudberryCluster {
...
// TestFunctional_Scenario54_ExporterCredentialsSecret_Created verifies that
// after reconciliation, the exporter credentials Secret exists with the
// expected keys (password and dsn).
func (s *Scenario54ExporterDeploymentSuite) TestFunctional_Scenario54_ExporterCredentialsSecret_Created() {
	// Arrange
	cluster := scenario54FullExporterCluster()
...
// TestFunctional_Scenario54_ExporterQueriesConfigMap_Created verifies that
// after reconciliation, the exporter queries ConfigMap exists with the
// expected queries.yaml key.
func (s *Scenario54ExporterDeploymentSuite) TestFunctional_Scenario54_ExporterQueriesConfigMap_Created() {
	// Arrange
	cluster := scenario54FullExporterCluster()
	env := testutil.NewTestK8sEnv(cluster)
...
// TestFunctional_Scenario54_CoordinatorStatefulSet_HasSidecars verifies that
...
func (s *Scenario54ExporterDeploymentSuite) TestFunctional_Scenario54_CoordinatorStatefulSet_HasSidecars() {
	// Arrange
	cluster := scenario54FullExporterCluster()
...
// TestFunctional_Scenario54_PostgresExporter_ContainerArgs verifies that the
// postgres-exporter sidecar container has the correct command-line arguments.
func (s *Scenario54ExporterDeploymentSuite) TestFunctional_Scenario54_PostgresExporter_ContainerArgs() {
	// Arrange
	cluster := scenario54FullExporterCluster()
	b := builder.NewBuilder()
...
// TestFunctional_Scenario54_CloudberryQueryExporter_ContainerArgs verifies that
...
func (s *Scenario54ExporterDeploymentSuite) TestFunctional_Scenario54_CloudberryQueryExporter_ContainerArgs() {
	// Arrange
	cluster := scenario54FullExporterCluster()
	b := builder.NewBuilder()
...
// TestFunctional_Scenario54_ExporterEnvFromSecret verifies that both exporter
// sidecar containers have the DATA_SOURCE_NAME environment variable sourced
// from the exporter credentials Secret.
func (s *Scenario54ExporterDeploymentSuite) TestFunctional_Scenario54_ExporterEnvFromSecret() {
	// Arrange
	cluster := scenario54FullExporterCluster()
	b := builder.NewBuilder()
...
// TestFunctional_Scenario54_NodeExporterDaemonSet_Created verifies that after
// reconciliation, the node exporter DaemonSet exists with the correct labels,
// hostPID, hostNetwork, args, and volumes.
func (s *Scenario54ExporterDeploymentSuite) TestFunctional_Scenario54_NodeExporterDaemonSet_Created() {
	// Arrange
	cluster := scenario54FullExporterCluster()
	env := testutil.NewTestK8sEnv(cluster)
...
// TestFunctional_Scenario54_ExporterService_Created verifies that after
// reconciliation, the exporter metrics Service exists with ports 9187 and 9188.
func (s *Scenario54ExporterDeploymentSuite) TestFunctional_Scenario54_ExporterService_Created() {
	// Arrange
	cluster := scenario54FullExporterCluster()
	env := testutil.NewTestK8sEnv(cluster)
...
// TestFunctional_Scenario54_ServiceMonitor_Built verifies that the builder
// produces a correctly structured ServiceMonitor unstructured object with
// the expected kind, API version, and name.
func (s *Scenario54ExporterDeploymentSuite) TestFunctional_Scenario54_ServiceMonitor_Built() {
	// Arrange
	cluster := scenario54FullExporterCluster()
	b := builder.NewBuilder()
...
// TestFunctional_Scenario54_PrometheusRule_Built verifies that the builder
...
func (s *Scenario54ExporterDeploymentSuite) TestFunctional_Scenario54_PrometheusRule_Built() {
	// Arrange
	cluster := scenario54FullExporterCluster()
	b := builder.NewBuilder()

...
// scenario5MockDBFactory implements api.DBClientFactory for testing.
...
func newScenario5Server(cluster *cbv1alpha1.CloudberryCluster, dbFactory api.DBClientFactory) *api.Server {

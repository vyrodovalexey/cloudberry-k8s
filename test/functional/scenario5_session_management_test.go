...
func (m *scenario5MockDBClient) GetDiskUsagePercent(_ context.Context) (int32, error) {
	return 0, nil
}
func (m *scenario5MockDBClient) GetClusterDataSizeBytes(_ context.Context) (int64, error) {
	return 0, nil
}
func (m *scenario5MockDBClient) GetBloatRecommendations(_ context.Context, _ db.RecommendationThresholds) ([]db.Recommendation, error) {
	return nil, nil
}
func (m *scenario5MockDBClient) GetSkewRecommendations(_ context.Context, _ db.RecommendationThresholds) ([]db.Recommendation, error) {
	return nil, nil
}
func (m *scenario5MockDBClient) GetAgeRecommendations(_ context.Context, _ db.RecommendationThresholds) ([]db.Recommendation, error) {
	return nil, nil
}
func (m *scenario5MockDBClient) GetIndexBloatRecommendations(_ context.Context, _ db.RecommendationThresholds) ([]db.Recommendation, error) {
	return nil, nil
}
func (m *scenario5MockDBClient) TriggerRecommendationScan(_ context.Context) error { return nil }
func (m *scenario5MockDBClient) GetTables(_ context.Context) ([]db.TableStorageInfo, error) {
	return nil, nil
}
...
func (m *scenario5MockDBClient) SeedNewSegmentCatalog(_ context.Context, _ db.SegmentRegistrationOptions) (int, error) {
	return 0, nil
}
...
func (m *scenario5MockDBClient) GpexpandSchemaPresent(_ context.Context) (bool, error) {
	return false, nil
}
func (m *scenario5MockDBClient) FinalizeGpexpand(_ context.Context) error {
	return nil
}
...
func (m *scenario5MockDBClient) SetupPXFExtensions(_ context.Context) (int, error) {
	return 2, nil
}

// EnsureDataLoaderRole implements db.Client.
func (m *scenario5MockDBClient) EnsureDataLoaderRole(_ context.Context, _ string) error {
	return nil
}

// ListPXFExtensions implements db.Client.
func (m *scenario5MockDBClient) ListPXFExtensions(_ context.Context) ([]string, error) {
	return nil, nil
}

// ListExternalTables implements db.Client.
func (m *scenario5MockDBClient) ListExternalTables(_ context.Context) ([]db.ExternalTableInfo, error) {
	return nil, nil
}

// ReadPXFSourceSample implements db.Client.
func (m *scenario5MockDBClient) ReadPXFSourceSample(

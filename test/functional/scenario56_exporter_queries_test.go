...
// ============================================================================
// Scenario 56: Exporter Queries ConfigMap Content
// ============================================================================
//
...
// Scenario56ExporterQueriesSuite tests the exporter queries ConfigMap content
// through the builder.
type Scenario56ExporterQueriesSuite struct {
	suite.Suite
	ctx context.Context
}

func TestFunctional_Scenario56(t *testing.T) {
	t.Parallel()
	suite.Run(t, new(Scenario56ExporterQueriesSuite))
}

func (s *Scenario56ExporterQueriesSuite) SetupTest() {
	s.ctx = context.Background()
}

// scenario56Cluster returns a cluster with query monitoring enabled for testing
// exporter queries ConfigMap content.
func scenario56Cluster() *cbv1alpha1.CloudberryCluster {
...
// TestFunctional_Scenario56a_ConnectionMetrics verifies that queries.yaml
...
func (s *Scenario56ExporterQueriesSuite) TestFunctional_Scenario56a_ConnectionMetrics() {
	// Arrange
...
// TestFunctional_Scenario56b_DatabaseStatistics verifies that queries.yaml
...
// deadlocks.
func (s *Scenario56ExporterQueriesSuite) TestFunctional_Scenario56b_DatabaseStatistics() {
	// Arrange
	cluster := scenario56Cluster()
	b := builder.NewBuilder()
...
// TestFunctional_Scenario56c_SegmentHealth verifies that queries.yaml contains
...
func (s *Scenario56ExporterQueriesSuite) TestFunctional_Scenario56c_SegmentHealth() {
	// Arrange
	cluster := scenario56Cluster()
	b := builder.NewBuilder()
...
// TestFunctional_Scenario56d_LockMetrics verifies that queries.yaml contains
// cloudberry_locks with labels mode, locktype, state (granted/waiting).
func (s *Scenario56ExporterQueriesSuite) TestFunctional_Scenario56d_LockMetrics() {
	// Arrange
	cluster := scenario56Cluster()
	b := builder.NewBuilder()
...
// TestFunctional_Scenario56f_WALMetrics verifies that queries.yaml contains
// cloudberry_wal with wal_bytes_total counter.
func (s *Scenario56ExporterQueriesSuite) TestFunctional_Scenario56f_WALMetrics() {
	// Arrange
	cluster := scenario56Cluster()
	b := builder.NewBuilder()
...
// TestFunctional_Scenario56g_ReplicationMetrics verifies that queries.yaml
...
func (s *Scenario56ExporterQueriesSuite) TestFunctional_Scenario56g_ReplicationMetrics() {
	// Arrange
	cluster := scenario56Cluster()
	b := builder.NewBuilder()

...
// ============================================================================
// Scenario 58: Node Exporter Metrics (E2E)
// ============================================================================
//
...
// Scenario58NodeExporterMetricsE2ESuite tests the node-exporter Helm chart
// configuration and metric family definitions.
type Scenario58NodeExporterMetricsE2ESuite struct {
	suite.Suite
}

func TestE2E_Scenario58(t *testing.T) {
	t.Parallel()
	suite.Run(t, new(Scenario58NodeExporterMetricsE2ESuite))
}

// e2eChartYAML represents the structure of Chart.yaml for parsing.
type e2eChartYAML struct {
...
// e2eValuesYAML represents the structure of values.yaml for parsing.
type e2eValuesYAML struct {
	Image struct {
...
// TestE2E_Scenario58_ChartExists verifies that the node-exporter
// Chart.yaml exists and has the correct name and version fields.
func (s *Scenario58NodeExporterMetricsE2ESuite) TestE2E_Scenario58_ChartExists() {
...
// TestE2E_Scenario58_DaemonSetTemplate reads the DaemonSet template
...
func (s *Scenario58NodeExporterMetricsE2ESuite) TestE2E_Scenario58_DaemonSetTemplate() {
...
// TestE2E_Scenario58_ValuesDefaults reads values.yaml and verifies
// the default configuration: image repository, tag, metricsPort, hostPID,
// and hostNetwork settings.
func (s *Scenario58NodeExporterMetricsE2ESuite) TestE2E_Scenario58_ValuesDefaults() {
...
// TestE2E_Scenario58_MetricFamilies verifies that all 11 required
...
func (s *Scenario58NodeExporterMetricsE2ESuite) TestE2E_Scenario58_MetricFamilies() {

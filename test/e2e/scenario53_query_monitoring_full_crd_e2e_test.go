...
// ============================================================================
// Scenario 53: Query Monitoring Full CRD Configuration (E2E)
// ============================================================================
//
...
// Scenario53QueryMonitoringFullCRDE2ESuite tests the full query monitoring CRD
// configuration through the AdminReconciler.
type Scenario53QueryMonitoringFullCRDE2ESuite struct {
	suite.Suite
	env *testutil.TestK8sEnv
	ctx context.Context
}

func TestE2E_Scenario53(t *testing.T) {
	t.Parallel()
	suite.Run(t, new(Scenario53QueryMonitoringFullCRDE2ESuite))
}

func (s *Scenario53QueryMonitoringFullCRDE2ESuite) SetupTest() {
	s.ctx = context.Background()
}

func (s *Scenario53QueryMonitoringFullCRDE2ESuite) reqFor(cluster *cbv1alpha1.CloudberryCluster) ctrl.Request {
	return ctrl.Request{
...
func fullE2EExporterConfig() *cbv1alpha1.QueryMonitoringExportersSpec {
...
// TestE2E_Scenario53_FullCRDConfig_Reconciles verifies that a cluster
// with all QueryMonitoring fields set reconciles without error.
func (s *Scenario53QueryMonitoringFullCRDE2ESuite) TestE2E_Scenario53_FullCRDConfig_Reconciles() {
	...
	cluster.Spec.QueryMonitoring = &cbv1alpha1.QueryMonitoringSpec{
		...
		Exporters:          fullE2EExporterConfig(),
	}
...
// TestE2E_Scenario53_HistoryRetention_Applied verifies that the
// historyRetention field is retained after reconciliation.
func (s *Scenario53QueryMonitoringFullCRDE2ESuite) TestE2E_Scenario53_HistoryRetention_Applied() {
	// Arrange
	cluster := testutil.NewClusterBuilder("test-cluster", "default").
		WithFinalizer().
		WithPhase(cbv1alpha1.ClusterPhaseRunning).
...
// TestE2E_Scenario53_SamplingInterval_Propagated verifies that the
// samplingInterval field is retained after reconciliation.
func (s *Scenario53QueryMonitoringFullCRDE2ESuite) TestE2E_Scenario53_SamplingInterval_Propagated() {
	// Arrange
	cluster := testutil.NewClusterBuilder("test-cluster", "default").
		WithFinalizer().
		WithPhase(cbv1alpha1.ClusterPhaseRunning).
...
// TestE2E_Scenario53_GuestAccess_False verifies that guestAccess=false
// is retained after reconciliation.
func (s *Scenario53QueryMonitoringFullCRDE2ESuite) TestE2E_Scenario53_GuestAccess_False() {
	// Arrange
	cluster := testutil.NewClusterBuilder("test-cluster", "default").
		WithFinalizer().
		WithPhase(cbv1alpha1.ClusterPhaseRunning).
...
// TestE2E_Scenario53_PlanCollection_True verifies that planCollection=true
// is retained after reconciliation.
func (s *Scenario53QueryMonitoringFullCRDE2ESuite) TestE2E_Scenario53_PlanCollection_True() {
	// Arrange
	cluster := testutil.NewClusterBuilder("test-cluster", "default").
		WithFinalizer().
		WithPhase(cbv1alpha1.ClusterPhaseRunning).
...
// TestE2E_Scenario53_SlowQueryThreshold_Propagated verifies that the
// slowQueryThreshold field is retained after reconciliation.
func (s *Scenario53QueryMonitoringFullCRDE2ESuite) TestE2E_Scenario53_SlowQueryThreshold_Propagated() {
	// Arrange
	cluster := testutil.NewClusterBuilder("test-cluster", "default").
		WithFinalizer().
		WithPhase(cbv1alpha1.ClusterPhaseRunning).
...
// TestE2E_Scenario53_PostgresExporter_Parsed verifies that the postgres
// exporter configuration fields are correctly retained after reconciliation.
func (s *Scenario53QueryMonitoringFullCRDE2ESuite) TestE2E_Scenario53_PostgresExporter_Parsed() {
	// Arrange
	cluster := testutil.NewClusterBuilder("test-cluster", "default").
		WithFinalizer().
		WithPhase(cbv1alpha1.ClusterPhaseRunning).
...
// TestE2E_Scenario53_NodeExporter_Parsed verifies that the node exporter
// configuration fields are correctly retained after reconciliation.
func (s *Scenario53QueryMonitoringFullCRDE2ESuite) TestE2E_Scenario53_NodeExporter_Parsed() {
	// Arrange
	cluster := testutil.NewClusterBuilder("test-cluster", "default").
		WithFinalizer().
		WithPhase(cbv1alpha1.ClusterPhaseRunning).
...
// TestE2E_Scenario53_CloudberryQueryExporter_Parsed verifies that the
// cloudberry query exporter configuration fields are correctly retained after reconciliation.
func (s *Scenario53QueryMonitoringFullCRDE2ESuite) TestE2E_Scenario53_CloudberryQueryExporter_Parsed() {
	// Arrange
	cluster := testutil.NewClusterBuilder("test-cluster", "default").
		WithFinalizer().
		WithPhase(cbv1alpha1.ClusterPhaseRunning).
...
// TestE2E_Scenario53_ServiceMonitor_Parsed verifies that the ServiceMonitor
...
func (s *Scenario53QueryMonitoringFullCRDE2ESuite) TestE2E_Scenario53_ServiceMonitor_Parsed() {
	// Arrange
	cluster := testutil.NewClusterBuilder("test-cluster", "default").
		WithFinalizer().
		WithPhase(cbv1alpha1.ClusterPhaseRunning).
...
// TestE2E_Scenario53_PrometheusRule_Parsed verifies that the PrometheusRule
// configuration fields are correctly retained after reconciliation, including
// namespace defaulting to the cluster namespace when left empty.
func (s *Scenario53QueryMonitoringFullCRDE2ESuite) TestE2E_Scenario53_PrometheusRule_Parsed() {
	// Arrange
	cluster := testutil.NewClusterBuilder("test-cluster", "default").
		WithFinalizer().
		WithPhase(cbv1alpha1.ClusterPhaseRunning).
